...
import { addPost, cancelEditingPost, finishEditingPost } from 'pages/blog/blog.action'
...
export default function CreatePost() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault()
    // ...formData: spread operator là bản sao của formData, sao chép thuộc tính của formData và truyền cho formDataWithId
    const formDataWithId = { ...formData }
    dispatch(addPost(formDataWithId))
    setFormData(initialState)
  }
